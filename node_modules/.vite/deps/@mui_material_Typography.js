...
function createBox(options = {}) {
  ...
  const Box2 = k(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose2(_extendSxProp, _excluded4);
    return o(BoxRoot, _extends2({
      as: component,
      ref,
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    const defaultStyledResolver = styled(tag, _extends2({
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      const expressionsWithDefaultTheme = expressions ? expressions.map((stylesArg) => {
        return typeof stylesArg === "function" && stylesArg.__emotion_real !== stylesArg ? (props) => {
          return stylesArg(_extends2({}, props, {
            theme: resolveTheme(_extends2({}, props, {
              defaultTheme: defaultTheme5,
              themeId
            }))
        ...
        expressionsWithDefaultTheme.push((props) => {
          ...
          if (styleOverrides) {
            ...
            Object.entries(styleOverrides).forEach(([slotKey, slotStyle]) => {
              resolvedStyleOverrides[slotKey] = typeof slotStyle === "function" ? slotStyle(_extends2({}, props, {
                theme
              })) : slotStyle;
            });
      ...
      styleArg.__emotion_real !== styleArg) {
        transformedStyleArg = (props) => styleArg(_extends2({}, props, {
          theme: resolveTheme(_extends2({}, props, {
            defaultTheme: defaultTheme5,
            themeId
          }))
...
function mergeOuterLocalTheme(outerTheme, localTheme) {
  ...
  return _extends3({}, outerTheme, localTheme);
}
...
function createGrid(options = {}) {
  ...
  const Grid2 = k(function Grid3(inProps, ref) {
    ...
    } = props, rest = _objectWithoutPropertiesLoose2(props, _excluded8);
    ...
    let result = o(GridRoot, _extends2({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
var Typography = k(function Typography2(inProps, ref) {
  ...
  return o(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_default(classes.root, className)
