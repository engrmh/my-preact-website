import {
  ...
  forceReflow,
  removeClass
} from "./chunk-GWIMAOIZ.js";
import {
  Typography_default
} from "./chunk-CGHXOFQQ.js";
import {
  FocusTrap,
  Popper,
  Portal,
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return wn.createElement(Transition_default, _extends({}, props, {
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return wn.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return wn.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, wn.createElement(Component, props, children2));
  };
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = wn.Children.toArray(children2)[idx];
    if (child.props[handler])
      (_child$props = child.props)[handler].apply(_child$props, originalArgs);
    if (this.props[handler]) {
      var maybeNode = child.props.nodeRef ? void 0 : wn.findDOMNode(this);
      this.props[handler](maybeNode);
    }
  };
  _proto.render = function render() {
    var _this$props = this.props, children2 = _this$props.children, inProp = _this$props.in, props = _objectWithoutPropertiesLoose(_this$props, ["children", "in"]);
    var _React$Children$toArr = wn.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return wn.createElement(TransitionGroup_default, props, inProp ? wn.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : wn.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (wn.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (wn.isValidElement(oldChildren) && wn.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return wn.cloneElement(current, {
    in: false,
  ...
  return [current, wn.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return wn.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, wn.cloneElement(children2, {
        in: true
      }));
    })
  });
...
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: wn.cloneElement(props.children, {
        in: true
      })
    };
  };
...
var Chip = k2(function Chip2(inProps, ref) {
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && an(deleteIconProp) ? hn(deleteIconProp, {
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded8 = ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "components", "componentsProps", "defaultValue", "disabled", "disableInjectingGlobalStyles", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "slotProps", "slots", "startAdornment", "type", "value"];
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  autoComplete: import_prop_types15.default.bool,
  /**
   * If `true`, the first option is automatically highlighted.
   * @default false
   */
  autoHighlight: import_prop_types15.default.bool,
  /**
   ...
   * @default false
   */
  autoSelect: import_prop_types15.default.bool,
  /**
   ...
   * @default false
   */
  blurOnSelect: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["mouse", "touch"]), import_prop_types15.default.bool]),
  /**
   * Props applied to the [`Chip`](/material-ui/api/chip/) element.
   */
  ChipProps: import_prop_types15.default.object,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  clearIcon: import_prop_types15.default.node,
  /**
   ...
   */
  clearOnBlur: import_prop_types15.default.bool,
  /**
   * If `true`, clear all values when the user presses escape and the popup is closed.
   * @default false
   */
  clearOnEscape: import_prop_types15.default.bool,
  /**
   ...
   * @default 'Clear'
   */
  clearText: import_prop_types15.default.string,
  /**
  ...
  componentsProps: import_prop_types15.default.shape({
    clearIndicator: import_prop_types15.default.object,
    paper: import_prop_types15.default.object,
    popper: import_prop_types15.default.object,
    popupIndicator: import_prop_types15.default.object
  }),
  /**
   * The default value. Use when the component is not controlled.
   * @default props.multiple ? [] : null
   */
  defaultValue: chainPropTypes(import_prop_types15.default.any, (props) => {
   ...
   * @default false
   */
  disableClearable: import_prop_types15.default.bool,
  /**
   ...
   * @returns {Value[]}
   */
  filterOptions: import_prop_types15.default.func,
  /**
   * If `true`, hide the selected options from the list box.
   * @default false
   */
  filterSelectedOptions: import_prop_types15.default.bool,
  /**
   * Force the visibility display of the popup icon.
   * @default 'auto'
   */
  forcePopupIcon: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["auto"]), import_prop_types15.default.bool]),
  /**
   * If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options.
   * @default false
   */
  freeSolo: import_prop_types15.default.bool,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   * @default (more) => `+${more}`
   */
  getLimitTagsText: import_prop_types15.default.func,
  /**
   ...
   * @returns {boolean}
   */
  getOptionDisabled: import_prop_types15.default.func,
  /**
   ...
   */
  getOptionLabel: import_prop_types15.default.func,
  /**
   ...
   * @returns {string}
   */
  groupBy: import_prop_types15.default.func,
  /**
   * If `true`, the component handles the "Home" and "End" keys when the popup is open.
   * It should move focus to the first option and last option, respectively.
   * @default !props.freeSolo
   */
  handleHomeEndKeys: import_prop_types15.default.bool,
  /**
   ...
   * @default false
   */
  includeInputInList: import_prop_types15.default.bool,
  /**
   * The input value.
   */
  inputValue: import_prop_types15.default.string,
  /**
   ...
   * @returns {boolean}
   */
  isOptionEqualToValue: import_prop_types15.default.func,
  /**
   ...
   * @default 'ul'
   */
  ListboxComponent: import_prop_types15.default.elementType,
  /**
   * Props applied to the Listbox element.
   */
  ListboxProps: import_prop_types15.default.object,
  /**
   ...
   * @default 'Loading…'
   */
  loadingText: import_prop_types15.default.node,
  /**
   ...
   * @default 'No options'
   */
  noOptionsText: import_prop_types15.default.node,
  /**
   ...
   * @default false
   */
  openOnFocus: import_prop_types15.default.bool,
  /**
   ...
   * @default 'Open'
   */
  openText: import_prop_types15.default.string,
  /**
   * Array of options.
   */
  options: import_prop_types15.default.array.isRequired,
  /**
   ...
   */
  popupIcon: import_prop_types15.default.node,
  /**
   ...
   * @returns {ReactNode}
   */
  renderGroup: import_prop_types15.default.func,
  /**
   * Render the input.
   *
   * @param {object} params
   ...
   * @returns {ReactNode}
   */
  renderOption: import_prop_types15.default.func,
  /**
   ...
   * @returns {ReactNode}
   */
  renderTags: import_prop_types15.default.func,
  /**
   * If `true`, the input's text is selected on focus.
   * It helps the user clear the selected value.
   * @default !props.freeSolo
   */
  selectOnFocus: import_prop_types15.default.bool,
  /**
   * The size of the component.
   * @default 'medium'
   */
  size: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["small", "medium"]), import_prop_types15.default.string]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   */
  value: chainPropTypes(import_prop_types15.default.any, (props) => {
...
init_useThemeProps();
init_jsx_runtime();
var _excluded11 = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"];
...
var Badge = k2(function Badge2(inProps, ref) {
  ...
  return o(RootSlot, _extends({}, rootProps, {
    children: [children2, o(BadgeSlot, _extends({}, badgeProps, {
...
true ? Badge.propTypes = {
  ...
  anchorOrigin: import_prop_types18.default.shape({
    horizontal: import_prop_types18.default.oneOf(["left", "right"]).isRequired,
  ...
  componentsProps: import_prop_types18.default.shape({
    badge: import_prop_types18.default.oneOfType([import_prop_types18.default.func, import_prop_types18.default.object]),
   ...
   * @default 'rectangular'
   */
  overlap: import_prop_types18.default.oneOf(["circular", "rectangular"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["dot", "standard"]), import_prop_types18.default.string])
} : void 0;
...
init_compat_module();
var ButtonGroupButtonContext = G(void 0);
if (true) {
...
var Button = k2(function Button2(inProps, ref) {
  ...
  const buttonGroupButtonContextPositionClassName = q(ButtonGroupButtonContext_default);
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded14 = ["autoFocus", "checked", "checkedIcon", "className", "defaultChecked", "disabled", "disableFocusRipple", "edge", "icon", "id", "inputProps", "inputRef", "name", "onBlur", "onChange", "onFocus", "readOnly", "required", "tabIndex", "type", "value"];
...
init_styled();
init_jsx_runtime();
var _excluded15 = ["checkedIcon", "color", "icon", "indeterminate", "indeterminateIcon", "inputProps", "size", "className"];
...
var Checkbox = k2(function Checkbox2(inProps, ref) {
  ...
  return o(CheckboxRoot, _extends({
    ...
    checkedIcon: hn(indeterminateIcon, {
...
init_styled();
init_jsx_runtime();
var _excluded16 = ["className", "color", "disableShrink", "size", "style", "thickness", "value", "variant"];
var _3 = (t) => t;
var _t5;
var _t22;
var _t32;
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded17 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"];
...
var Modal = k2(function Modal2(inProps, ref) {
  ...
  return o(Portal, {
    ...
    container,
    disablePortal,
    children: o(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? o(BackdropSlot, _extends({}, backdropProps)) : null, o(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: hn(children2, childProps)
      })]
    }))
  });
});
...
var Divider = k2(function Divider2(inProps, ref) {
  ...
  return o(DividerRoot, _extends({
    ...
    children: children2 ? o(DividerWrapper, {
...
init_useThemeProps();
init_jsx_runtime();
var _excluded19 = ["disableUnderline", "components", "componentsProps", "fullWidth", "hiddenLabel", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
init_isMuiElement();
init_jsx_runtime();
var _excluded20 = ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"];
...
var FormControlLabel = k2(function FormControlLabel2(inProps, ref) {
  ...
  return o(FormControlLabelRoot, _extends({
    ...
    children: [hn(control, controlProps), required ? o(Stack_default, {
      direction: "row",
      alignItems: "center",
...
init_jsx_runtime();
var _span;
var _excluded23 = ["children", "className", "component", "disabled", "error", "filled", "focused", "margin", "required", "variant"];
...
init_styled();
init_jsx_runtime();
var _excluded24 = ["children", "className", "color", "component", "disabled", "error", "filled", "focused", "required"];
...
var FormLabel = k2(function FormLabel2(inProps, ref) {
  ...
  return o(FormLabelRoot, _extends({
    ...
    children: [children2, fcs.required && o(AsteriskComponent2, {
      ownerState,
      "aria-hidden": true,
      className: classes.asterisk,
      children: [" ", "*"]
...
init_useThemeProps();
init_jsx_runtime();
var _excluded26 = ["disableUnderline", "components", "componentsProps", "fullWidth", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
init_jsx_runtime();
var _span2;
var _excluded27 = ["children", "className", "component", "disablePointerEvents", "disableTypography", "position", "variant"];
...
var InputAdornment = k2(function InputAdornment2(inProps, ref) {
  ...
  return o(FormControlContext_default.Provider, {
    ...
    children: o(InputAdornmentRoot, _extends({
      ...
      children: typeof children2 === "string" && !disableTypography ? o(Typography_default, {
...
init_styled();
init_jsx_runtime();
var _excluded28 = ["disableAnimation", "margin", "shrink", "variant", "className"];
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded29 = ["children", "className", "component", "dense", "disablePadding", "subheader"];
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded31 = ["children", "className", "disableTypography", "inset", "primary", "primaryTypographyProps", "secondary", "secondaryTypographyProps"];
...
var MenuList = k2(function MenuList2(props, ref) {
  ...
  O.forEach(children2, (child, index) => {
    if (!an(child)) {
  ...
  const items = O.map(children2, (child, index) => {
...
init_useForkRef();
init_jsx_runtime();
var _excluded36 = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded38 = ["components", "fullWidth", "inputComponent", "label", "multiline", "notched", "slots", "type"];
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded39 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var SelectInput = k2(function SelectInput2(props, ref) {
  ...
  const childrenArray = O.toArray(children2);
...
var Select = k2(function Select2(inProps, ref) {
  ...
  return o(k, {
    children: hn(InputComponent, _extends({
...
init_useThemeProps();
init_jsx_runtime();
var _excluded42 = ["animation", "className", "component", "height", "style", "variant", "width"];
var _4 = (t) => t;
var _t6;
var _t23;
var _t33;
...
var Tooltip = k2(function Tooltip2(inProps, ref) {
  ...
  return o(k, {
    children: [hn(children2, childrenProps), o(PopperComponent, _extends({
...
init_jsx_runtime();
init_jsx_runtime();
var _excluded44 = ["className", "color", "edge", "size", "sx"];
...
init_styled();
init_jsx_runtime();
var _excluded45 = ["align", "className", "component", "padding", "scope", "size", "sortDirection", "variant"];
...
var TableCell = k2(function TableCell2(inProps, ref) {
  ...
  const tablelvl2 = q(Tablelvl2Context_default);
...
true ? TableCell.propTypes = {
   ...
   */
  padding: import_prop_types51.default.oneOf(["checkbox", "none", "normal"]),
  /**
   * Set scope attribute.
   */
   ...
   */
  variant: import_prop_types51.default.oneOfType([import_prop_types51.default.oneOf(["body", "footer", "head"]), import_prop_types51.default.string])
} : void 0;
...
init_styled();
init_jsx_runtime();
var _excluded46 = ["className", "component", "disableGutters", "variant"];
...
true ? Toolbar.propTypes = {
   ...
   * @default 'regular'
   */
  variant: import_prop_types52.default.oneOfType([import_prop_types52.default.oneOf(["dense", "regular"]), import_prop_types52.default.string])
} : void 0;
...
true ? TablePaginationActions.propTypes = {
   ...
   */
  backIconButtonProps: import_prop_types53.default.object,
  /**
   * The total number of rows.
   */
  count: import_prop_types53.default.number.isRequired,
  /**
   ...
   * @returns {string}
   */
  getItemAriaLabel: import_prop_types53.default.func.isRequired,
  /**
   * Props applied to the next arrow [`IconButton`](/material-ui/api/icon-button/) element.
   */
  nextIconButtonProps: import_prop_types53.default.object,
  /**
   ...
   */
  onPageChange: import_prop_types53.default.func.isRequired,
  /**
   * The zero-based index of the current page.
   */
  page: import_prop_types53.default.number.isRequired,
  /**
   * The number of rows per page.
   */
  rowsPerPage: import_prop_types53.default.number.isRequired,
  /**
   * If `true`, show the first-page button.
   */
  showFirstButton: import_prop_types53.default.bool.isRequired,
  /**
   * If `true`, show the last-page button.
   */
  showLastButton: import_prop_types53.default.bool.isRequired
} : void 0;
...
true ? TablePagination.propTypes = {
   ...
   */
  ActionsComponent: import_prop_types54.default.elementType,
  /**
   ...
   * @ignore
   */
  colSpan: import_prop_types54.default.number,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * }
   */
  labelDisplayedRows: import_prop_types54.default.func,
  /**
   ...
   */
  labelRowsPerPage: import_prop_types54.default.node,
  /**
   * Props applied to the next arrow [`IconButton`](/material-ui/api/icon-button/) element.
   */
   ...
   * @param {React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>} event The event source of the callback.
   */
  onRowsPerPageChange: import_prop_types54.default.func,
  /**
   * The zero-based index of the current page.
   */
   ...
   */
  rowsPerPageOptions: import_prop_types54.default.arrayOf(import_prop_types54.default.oneOfType([import_prop_types54.default.number, import_prop_types54.default.shape({
   ...
   * @default {}
   */
  SelectProps: import_prop_types54.default.object,
  /**
   * If `true`, show the first-page button.
   * @default false
   */
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MXNUKZ6R.js.map
