...
var eq$6 = (b) => (b & 240) >> 4 === (b & 15);
var isShort = (v) => eq$6(v.r) && eq$6(v.g) && eq$6(v.b) && eq$6(v.a);
...
function hsv2rgbn(h, s, v) {
  const f = (n, k2 = (n + h / 60) % 6) => v - v * s * Math.max(Math.min(k2, 4 - k2, 1), 0);
  return [f(5), f(3), f(1)];
}
...
function set(root2, scope, values) {
  if (typeof scope === "string") {
    return merge$2(getScope$1(root2, scope), values);
  }
  return merge$2(getScope$1(root2, ""), scope);
}
var Defaults = class {
...
function _longestText(ctx, font, arrayOfThings, cache) {
  ...
  for (i = 0; i < ilen; i++) {
    ...
    if (thing !== void 0 && thing !== null && isArray$a(thing) !== true) {
      longest = _measureText(ctx, data, gc, longest, thing);
    } else if (isArray$a(thing)) {
      for (j = 0, jlen = thing.length; j < jlen; j++) {
        nestedThing = thing[j];
        if (nestedThing !== void 0 && nestedThing !== null && !isArray$a(nestedThing)) {
...
function _readValueToProps(value, props) {
  ...
  const read = isObject$a(value) ? objProps ? (prop) => valueOrDefault(value[prop], value[props[prop]]) : (prop) => value[prop] : () => value;
...
function resolve(inputs, context, index2, info) {
  ...
  for (i = 0, ilen = inputs.length; i < ilen; ++i) {
    ...
    if (index2 !== void 0 && isArray$a(value)) {
...
var needsSubResolver = (prop, value) => isObject$a(value) && prop !== "adapters" && (Object.getPrototypeOf(value) === null || value.constructor === Object);
...
function _resolveWithContext(target, prop, receiver) {
  ...
  if (isFunction$4(value) && descriptors2.isScriptable(prop)) {
...
function registerDefaults(item, scope, parentScope) {
  const itemDefaults = merge$2(/* @__PURE__ */ Object.create(null), [
...
var Config = class {
  ...
  createResolver(scopes, context, prefixes = [""], descriptorDefaults) {
    ...
    return isObject$a(context) ? _attachContext(resolver, context, void 0, descriptorDefaults) : resolver;
  }
};
...
var hasFunction = (value) => isObject$a(value) && Object.getOwnPropertyNames(value).reduce((acc, key) => acc || isFunction$4(value[key]), false);
function needContext(proxy, names2) {
  ...
  for (const prop of names2) {
    ...
    if (scriptable && (isFunction$4(value) || hasFunction(value)) || indexable && isArray$a(value)) {
      return true;
    }
  }
  return false;
...
function isIterateeCall$1(value, index2, object) {
  ...
  if (type == "number" ? isArrayLike$5(object) && isIndex$2(index2, object.length) : type == "string" && index2 in object) {
...
var CChart = k(function(_a, ref) {
  ...
  var canvas = function(ref2) {
    return wn.createElement("canvas", __assign({}, !wrapper && className && { className }, { "data-testid": "canvas", height, id, onClick: function(e) {
      handleOnClick(e);
    }, ref: ref2, role: "img", width }, rest), fallbackContent);
  };
  return wrapper ? wn.createElement("div", __assign({ className: classNames("chart-wrapper", className) }, rest), canvas(canvasRef)) : canvas(canvasRef);
});
CChart.propTypes = {
...
var CChartBar = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "bar", ref }));
});
CChartBar.displayName = "CChartBar";
var CChartBubble = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "bubble", ref }));
});
CChartBubble.displayName = "CChartBubble";
var CChartDoughnut = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "doughnut", ref }));
});
CChartDoughnut.displayName = "CChartDoughnut";
var CChartLine = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "line", ref }));
});
CChartLine.displayName = "CChartLine";
var CChartPie = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "pie", ref }));
});
CChartPie.displayName = "CChartPie";
var CChartPolarArea = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "polarArea", ref }));
});
CChartPolarArea.displayName = "CChartPolarArea";
var CChartRadar = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "radar", ref }));
});
CChartRadar.displayName = "CChartRadar";
var CChartScatter = k(function(props, ref) {
  return wn.createElement(CChart, __assign({}, props, { type: "scatter", ref }));
});
...
@coreui/react-chartjs/dist/index.es.js:
