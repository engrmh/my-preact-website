...
var CChart = k(function(_a, ref) {
  ...
  var canvas = function(ref2) {
    return Cn.createElement("canvas", __assign({}, !wrapper && className && { className }, { "data-testid": "canvas", height, id, onClick: function(e) {
      handleOnClick(e);
    }, ref: ref2, role: "img", width }, rest), fallbackContent);
  };
  return wrapper ? Cn.createElement("div", __assign({ className: classNames("chart-wrapper", className) }, rest), canvas(canvasRef)) : canvas(canvasRef);
});
CChart.propTypes = {
