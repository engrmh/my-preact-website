...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2) {
  ...
  for (var i = 0, j = 0, k3 = 0; i < index; ++i)
    for (var x = 0, y3 = substr(value, post + 1, post = abs(j = points[i])), z = value; x < size; ++x)
      if (z = trim(j > 0 ? rule[x] + " " + y3 : replace(y3, /&\f/g, rule[x])))
        props[k3++] = z;
  ...
  "node_modules/@emotion/react/dist/emotion-react.browser.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache) {
      ...
      if (!isBrowser2) {
        ...
        return y("style", (_ref = {}, _ref["data-emotion"] = cache.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZD36YU4N.js.map
