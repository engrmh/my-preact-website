...
function f(n) {
  ...
  return e.reduce(function(n2, e2) {
    n2 += "  in " + a(e2);
    var t2 = e2.__source;
    return t2 ? n2 += " (at " + t2.fileName + ":" + t2.lineNumber + ")" : c || (c = true, console.warn("Add @babel/plugin-transform-react-jsx-source to get a more detailed component stack. Note that you should not add it to production builds of your App for bundle size reasons.")), n2 + "\n";
  }, "");
}
...
b.prototype.forceUpdate = function(n) {
  return null == this.__v ? console.warn('Calling "this.forceUpdate" inside the constructor of a component is a no-op and might be a bug in your application.\n\n' + f(l2())) : null == this.__P && console.warn(`Can't call "this.forceUpdate" on an unmounted component. This is a no-op, but it indicates a memory leak in your application. To fix, cancel all subscriptions and asynchronous tasks in the componentWillUnmount method.
...
` + f(this.__v)), b2.call(this, n);
  ...
  var n = false, t = l.__b, r2 = l.diffed, l3 = l.vnode, c2 = l.__r, v2 = l.__e, b3 = l.__, g = l.__h, E = l.__c, k2 = p ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, _ = [], I = [];
  l.__e = function(n2, e, t2, o2) {
    ...
    var r3 = e.type;
    if (("string" == typeof r3 && y(r3) || "p" === r3) && I.push(e), n = true, void 0 === r3)
    ...
    if ("string" == typeof e.type) {
      for (var i2 in e.props)
        if ("o" === i2[0] && "n" === i2[1] && "function" != typeof e.props[i2] && null != e.props[i2])
          throw new Error(`Component's "` + i2 + '" property should be a function, but got [' + typeof e.props[i2] + "] instead\n" + w(e) + "\n\n" + f(e));
    }
    if ("function" == typeof e.type && e.type.propTypes) {
      if ("Lazy" === e.type.displayName && k2 && !k2.lazyPropTypes.has(e.type)) {
        var s2 = "PropTypes are not supported on lazy(). Use propTypes on the wrapped component itself. ";
        try {
          var l4 = e.type();
          k2.lazyPropTypes.set(e.type, true), console.warn(s2 + "Component wrapped in lazy() is " + a(l4));
        } catch (n2) {
          console.warn(s2 + "We will log the wrapped component's name once it is loaded.");
        }
      }
      var c3 = e.props;
      e.type.__f && delete (c3 = function(n2, e2) {
        for (var t2 in e2)
          n2[t2] = e2[t2];
        return n2;
      }({}, c3)).ref, function(n2, e2, t2, r4, a2) {
      ...
      }(e.type.propTypes, c3, 0, a(e), function() {
        return f(e);
      });
    }
    t && t(e);
  ...
  var T = function(n2, e) {
    return { get: function() {
      var t2 = "get" + n2 + e;
      _ && _.indexOf(t2) < 0 && (_.push(t2), console.warn("getting vnode." + n2 + " is deprecated, " + e));
    }, set: function() {
      var t2 = "set" + n2 + e;
      _ && _.indexOf(t2) < 0 && (_.push(t2), console.warn("setting vnode." + n2 + " is not allowed, " + e));
    } };
  }, j = { nodeName: T("nodeName", "use vnode.type"), attributes: T("attributes", "use vnode.props"), children: T("children", "use vnode.props.children") }, O = Object.create({}, j);
  l.vnode = function(n2) {
    var e = n2.props;
    ...
    if (null != e.__c && null != e.__c.__H) {
      var l4 = e.__c.__H.__;
      if (l4)
        for (var c3 = 0; c3 < l4.length; c3 += 1) {
          var u2 = l4[c3];
          if (u2.__H) {
            for (var p2 = 0; p2 < u2.__H.length; p2++)
              if ((h2 = u2.__H[p2]) != h2) {
                var d2 = a(e);
                throw new Error("Invalid argument passed to hook. Hooks should not be called with NaN in the dependency array. Hook index " + c3 + " in component " + d2 + " was called with NaN.");
              }
          }
        }
    }
    ...
    for (var t2 = 0; t2 < I.length; t2++) {
      var o2 = I[t2], r3 = o2.type, a2 = h(o2.__);
      if ("table" === r3 && y(a2))
        console.error("Improper nesting of table. Your <table> should not have a table-node parent." + w(o2) + "\n\n" + f(o2));
      else if ("thead" !== r3 && "tfoot" !== r3 && "tbody" !== r3 || "table" === a2) {
        if ("tr" === r3 && "thead" !== a2 && "tfoot" !== a2 && "tbody" !== a2 && "table" !== a2)
          console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot/table> parent." + w(o2) + "\n\n" + f(o2));
        else if ("td" === r3 && "tr" !== a2)
          console.error("Improper nesting of table. Your <td> should have a <tr> parent." + w(o2) + "\n\n" + f(o2));
        else if ("th" === r3 && "tr" !== a2)
          console.error("Improper nesting of table. Your <th> should have a <tr>." + w(o2) + "\n\n" + f(o2));
        else if ("p" === r3) {
          var i2 = d(o2).filter(function(n3) {
            return m.test(n3);
          });
          i2.length && console.error("Improper nesting of paragraph. Your <p> should not have " + i2.join(", ") + "as child-elements." + w(o2) + "\n\n" + f(o2));
        }
      } else
        console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent." + w(o2) + "\n\n" + f(o2));
    }
    I = [], E && E(n2, e);
  };
}();
