...
var TimelineOppositeContent = k(function TimelineOppositeContent2(inProps, ref) {
  ...
  } = q(TimelineContext_default);
  const ownerState = _extends({}, props, {
    position: positionContext || "left"
  });
  const classes = useUtilityClasses(ownerState);
  return o(TimelineOppositeContentRoot, _extends({
    component: "div",
...
var TimelineItem = k(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  O.forEach(props.children, (child) => {
  ...
  return o(TimelineContext_default.Provider, {
    value: contextValue,
    children: o(TimelineItemRoot, _extends({
      className: clsx_default(classes.root, className),
      ownerState,
      ref
    }, other))
