import {
  bindActionCreators
} from "./chunk-PZN4WNIZ.js";
import "./chunk-VHSD2DZH.js";
import {
  b,
  init_preact_module,
  y
...
// node_modules/preact-context/dist/esm/context.js
init_preact_module();

// node_modules/preact-context/dist/esm/context-value-emitter.js
...
// node_modules/preact-context/dist/esm/utils.js
...
function _createContext(value, bitmaskFactory) {
  ...
  var Consumer = (
    /** @class */
    function(_super) {
      __extends(Consumer2, _super);
      function Consumer2(props, ctx) {
        var _this = _super.call(this, props, ctx) || this;
        _this._updateContext = function(value2, bitmask) {
          var unstable_observedBits = _this.props.unstable_observedBits;
          var observed = unstable_observedBits === void 0 || unstable_observedBits === null ? MAX_SIGNED_31_BIT_INT : unstable_observedBits;
          observed = observed | 0;
      ...
      Consumer2.prototype.componentDidMount = function() {
        this._getEmitter().register(this._updateContext);
      };
      Consumer2.prototype.shouldComponentUpdate = function(nextProps, nextState) {
        return this.state.value !== nextState.value || getRenderer(this.props) !== getRenderer(nextProps);
      };
      Consumer2.prototype.componentWillUnmount = function() {
        this._getEmitter().unregister(this._updateContext);
      };
      Consumer2.prototype.componentDidUpdate = function(_, __, prevCtx) {
      ...
      Consumer2.prototype.render = function() {
      ...
      Consumer2.prototype._getEmitter = function() {
...
var reactIs_production_min = createCommonjsModule(function(module, exports) {
  ...
  var c = 60103, d = 60106, e = 60107, f = 60108, g = 60114, h = 60109, k = 60110, l = 60111, m = 60111, n = 60112, p = 60113, q = 60115, r = 60116;
  function t(a) {
...
function connectAdvanced(selectorFactory, _temp) {
  var _ref = _temp === void 0 ? {} : _temp, _ref$getDisplayName = _ref.getDisplayName, getDisplayName = _ref$getDisplayName === void 0 ? function(name) {
    return "ConnectAdvanced(" + name + ")";
  } : _ref$getDisplayName, _ref$methodName = _ref.methodName, methodName = _ref$methodName === void 0 ? "connectAdvanced" : _ref$methodName, _ref$renderCountProp = _ref.renderCountProp, renderCountProp = _ref$renderCountProp === void 0 ? void 0 : _ref$renderCountProp, _ref$shouldHandleStat = _ref.shouldHandleStateChanges, shouldHandleStateChanges = _ref$shouldHandleStat === void 0 ? true : _ref$shouldHandleStat, _ref$storeKey = _ref.storeKey, storeKey = _ref$storeKey === void 0 ? "store" : _ref$storeKey, _ref$withRef = _ref.withRef, _ref$forwardRef = _ref.forwardRef, forwardRef = _ref$forwardRef === void 0 ? false : _ref$forwardRef, _ref$context = _ref.context, context = _ref$context === void 0 ? ReactReduxContext : _ref$context, connectOptions = _objectWithoutPropertiesLoose(_ref, ["getDisplayName", "methodName", "renderCountProp", "shouldHandleStateChanges", "storeKey", "withRef", "forwardRef", "context"]);
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var OuterBaseComponent = b;
    if (pure) {
      OuterBaseComponent = b;
    }
    function makeDerivedPropsSelector() {
      ...
      var sourceSelector;
      return function selectDerivedProps(state, props, store, selectorFactoryOptions2) {
        if (pure && lastProps === props && lastState === state) {
          return lastDerivedProps;
        }
        if (store !== lastStore || lastSelectorFactoryOptions !== selectorFactoryOptions2) {
          lastStore = store;
          lastSelectorFactoryOptions = selectorFactoryOptions2;
          sourceSelector = selectorFactory(store.dispatch, selectorFactoryOptions2);
        }
        lastProps = props;
        lastState = state;
    ...
    function makeChildElementSelector() {
      ...
      return function selectChildElement(WrappedComponent2, childProps, forwardRef2) {
        if (childProps !== lastChildProps || forwardRef2 !== lastForwardRef || lastComponent !== WrappedComponent2) {
          lastChildProps = childProps;
          lastForwardRef = forwardRef2;
          lastComponent = WrappedComponent2;
          lastChildElement = React.createElement(WrappedComponent2, _extends({}, childProps, {
            ref: forwardRef2
          }));
        }
    ...
    var Connect = function(_OuterBaseComponent) {
      _inheritsLoose(Connect2, _OuterBaseComponent);
      function Connect2(props) {
        var _this;
...
function createConnect(_temp) {
  ...
  return function connect2(mapStateToProps, mapDispatchToProps, mergeProps, _temp2) {
    var _ref2 = _temp2 === void 0 ? {} : _temp2, _ref2$pure = _ref2.pure, pure = _ref2$pure === void 0 ? true : _ref2$pure, _ref2$areStatesEqual = _ref2.areStatesEqual, areStatesEqual = _ref2$areStatesEqual === void 0 ? strictEqual : _ref2$areStatesEqual, _ref2$areOwnPropsEqua = _ref2.areOwnPropsEqual, areOwnPropsEqual = _ref2$areOwnPropsEqua === void 0 ? shallowEqual : _ref2$areOwnPropsEqua, _ref2$areStatePropsEq = _ref2.areStatePropsEqual, areStatePropsEqual = _ref2$areStatePropsEq === void 0 ? shallowEqual : _ref2$areStatePropsEq, _ref2$areMergedPropsE = _ref2.areMergedPropsEqual, areMergedPropsEqual = _ref2$areMergedPropsE === void 0 ? shallowEqual : _ref2$areMergedPropsE, extraOptions = _objectWithoutPropertiesLoose(_ref2, ["pure", "areStatesEqual", "areOwnPropsEqual", "areStatePropsEqual", "areMergedPropsEqual"]);
...
var preact_redux_esm_default = index;
export {
  Provider,
  ReactReduxContext,
  connect,
  connectAdvanced,
  preact_redux_esm_default as default
};
