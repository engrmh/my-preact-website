...
function h2(e) {
  ...
  return function(e2) {
    ...
    }, [h3]), wn.createElement(wn.Fragment, null, u2);
  };
}
function y2(t, e) {
...
var T = (e) => {
  ...
  return wn.createElement("svg", { viewBox: "0 0 24 24", width: "100%", height: "100%", fill: "colored" === n ? "currentColor" : `var(--toastify-icon-color-${o})`, ...s2 });
};
var E = { info: function(e) {
  return wn.createElement(T, { ...e }, wn.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}, warning: function(e) {
  return wn.createElement(T, { ...e }, wn.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}, success: function(e) {
  return wn.createElement(T, { ...e }, wn.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(e) {
  return wn.createElement(T, { ...e }, wn.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}, spinner: function() {
  return wn.createElement("div", { className: "Toastify__spinner" });
} };
function C(t) {
  ...
  function L2(t2, n) {
    ...
    M2.iconOut = function(t3) {
      ...
      return false === r3 || (p2(r3) ? i2 = r3(l3) : an(r3) ? i2 = hn(r3, l3) : d(r3) || u(r3) ? i2 = r3 : s3 ? i2 = E.spinner() : ((t4) => t4 in E)(o2) && (i2 = E[o2](l3))), i2;
    ...
    let x2 = t2;
    an(t2) && !d(t2.type) ? x2 = hn(t2, { closeToast: L3, toastProps: M2, data: T3 }) : p2(t2) && (x2 = t2({ closeToast: L3, toastProps: M2, data: T3 })), b3.limit && b3.limit > 0 && C2.count > b3.limit && N2 ? C2.queue.push({ toastContent: x2, toastProps: M2, staleId: r2 }) : u(s2) ? setTimeout(() => {
      O2(x2, M2, r2);
    }, s2) : O2(x2, M2, r2);
  }
  function O2(t2, e, n) {
...
function L(e) {
  ...
  return wn.createElement("button", { className: `Toastify__close-button Toastify__close-button--${o}`, type: "button", onClick: (t) => {
    t.stopPropagation(), n(t);
  }, "aria-label": s2 }, wn.createElement("svg", { "aria-hidden": "true", viewBox: "0 0 14 16" }, wn.createElement("path", { fillRule: "evenodd", d: "M7.71 8.23l3.75 3.75-1.48 1.48-3.75-3.75-3.75 3.75L1 11.98l3.75-3.75L1 4.48 2.48 3l3.75 3.75L9.98 3l1.48 1.48-3.75 3.75z" })));
}
function O(e) {
  ...
  return wn.createElement("div", { role: "progressbar", "aria-hidden": h3 ? "true" : "false", "aria-label": "notification timer", className: T2, style: y3, [u2 && d2 >= 1 ? "onTransitionEnd" : "onAnimationEnd"]: u2 && d2 < 1 ? null : () => {
    f2 && s2();
  } });
}
var N = (n) => {
  ...
  let Q2 = null;
  return false === l || (Q2 = p2(l) ? l(q2) : an(l) ? hn(l, q2) : L(q2)), wn.createElement(y3, { isIn: P2, done: k3, position: v2, preventExitTransition: s2, nodeRef: r2 }, wn.createElement("div", { id: $2, onClick: m2, className: H2, ...i, style: E2, ref: r2 }, wn.createElement("div", { ...P2 && { role: R2 }, className: p2(C2) ? C2({ type: f2 }) : clsx_m_default("Toastify__toast-body", C2), style: b2 }, null != D2 && wn.createElement("div", { className: clsx_m_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !B2 }) }, D2), wn.createElement("div", null, u2)), Q2, wn.createElement(O, { ...M2 && !S2 ? { key: `pb-${M2}` } : {}, rtl: x2, theme: z2, delay: d2, isRunning: o, isIn: P2, closeToast: h3, hide: g2, type: f2, style: N2, className: I2, controlledProgress: S2, progress: w2 || 0 })));
};
var M = function(t, e) {
...
var k2 = k((e, n) => {
  ...
  }, []), wn.createElement("div", { ref: a, className: "Toastify", id: d2 }, o((e2, n2) => {
    const o2 = n2.length ? { ...l } : { ...l, pointerEvents: "none" };
    return wn.createElement("div", { className: f2(e2), style: o2, key: `container-${e2}` }, n2.map((e3, o3) => {
      let { content: s2, props: a2 } = e3;
      return wn.createElement(N, { ...a2, isIn: r2(a2.toastId), style: { ...a2.style, "--nth": o3 + 1, "--len": n2.length }, key: `toast-${a2.key}` }, s2);
    }));
  }));
});
